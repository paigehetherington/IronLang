...
public class Main {
    ...
    public static void processCommand(Scanner scanner, ArrayList<HashMap<String, String>> variables, String line) {
        ...
        if (vars.containsKey(params)) {
            params = vars.get(params); //pulling from combined map
        }
        switch (cmd) {
            case "PREACH_IT":
            ...
            case "KEEP_DOIN_DAT":
                ...
                break;
            case "IF_DAT_BOOTY_KEEPS_POPPIN":
	...
	// write your code here
        ...
        while (scanner.hasNext()) {
            ...
            processCommand(scanner, variables, line); //add scanner as argument instead of making global
        }
